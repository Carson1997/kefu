...
export default {
  ...
  computed: {
    ...
    shopContent: function () { // 重要法则内容
      return this.$PUBILC.html_decode(this.$store.state.SHOP_CONTENT);
    }
  },
...
.prompt-see-area .head {
  font-weight: 600;
}

.prompt-see-area .left-fir {
  padding-left: 15px;
  font-weight: 500;
}

.prompt-see-area .left-sec {
  padding-left: 30px;
  padding-top: 5px;
}
</style>
